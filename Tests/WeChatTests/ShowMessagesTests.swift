...
final class ShowMessagesTests: XCTestCase {
  func testToStr() throws {
    let message1 = Message(user: "我", message: "I created a WeChat CLI tool.", index: 0, date: "")
    let message2 = Message(user: "user1", message: "Looks good.", index: 1, date: "")
    let message3 = Message(user: "user1", message: "发送了一个图片", index: 2, date: "11:55")
    let message4 = Message(
      user: "user1", message: "This marks a new beginning.", index: 3, date: "12:12")
    let message5 = Message(user: "user1", message: "发送了一个图片", index: 4, date: "12:12")
    let message6 = Message(user: "user1", message: "哈哈", index: 5, date: "12:12")
    let message7 = Message(user: "我", message: "哈哈", index: 6, date: "12:12")
    ...
    let chatInfo = ChatInfo(title: "user1", element: AXUIElementCreateSystemWide(), index: 0)
